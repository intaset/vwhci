...
$confirmed = 0;
 ...
 // now we insert it into the database
  ...
  $subject = "International Journal of Virtual Worlds and Human Computer Interaction (VWHCI)"; 
  $message = "Thank you for signing up to receive alerts for VWHCI - International Journal of Virtual Worlds and Human Computer Interaction.
...
<div class="desktop jhead">
  ...
  <div class="main-content j-home">
    ...
    <p class="body">Thank you for subscribing to VWHCI - International Journal of Virtual Worlds and Human Computer Interaction. A confirmation email has been sent to your email. Please click on the confirmation link available in the email to confirm your subscription.</p>
